...
<body>
    ...
    <header>
        <div class="header-content">
            <h1>
                Tasty Dishes Just a Click Away
              </h1>
            <div class="categories">
                ...
                <button class="filter-btn" data-category="bestdish4" onclick="window.location.href='../html/bestdish.html'">Best Dish</button>
            </div>
        </div>
    </header>
    <main>
        ...
        <div class="food-container">
          ...
          <a href="breakfast.php#omlete">
            ...
            <div class="food-item breakfast">
                ...
                <h3>Pumpkin Soup</h3>
                <p>This pumpkin soup is deliciously creamy and smooth.</p>
            </div></a>
                ...
                <a href="lunch.php#chickenwraps">
                    ...
                    <a href="lunch.php#tortellini">
                        <div class="food-item lunch">
                            ...
                            <p>This Italian tortellini salad is truly a delicious summertime pasta dish, but we enjoy it all year long.</p>
                        </div></a>
            ...
            <div class="food-item dinner">
                ...
                <p>A five-ingredient hamburger rice casserole topped with melty cheese. </p>
            </div>
            </a>
            ...
            <div class="food-item dinner">
                ...
                <p>Get a taste of island life with Jamaican jerk-seasoned shrimp, roasted veggies.</p>
            </div></a>
            ...
            <div class="food-item desserts">
                ...
                <p>Chocolate brownie studded with sour cherries and topped with whipped cream, melted milk chocolate and fresh cherries.</p>
            </div></a>
