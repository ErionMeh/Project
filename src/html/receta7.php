...
<body>
    ...
    <div>
        ...
        <div id="div4">
            <h1 id="h5">How to Proof Yeast</h1>
            <img id="img2" src="../../assets/images/receta7.1.jpg">
            <p id="p5">
                It’s worth noting that proofing yeast is different than proofing bread dough. Here’s how to proof yeast, step by step.
            </p>
        </div>
        <div id="div1">
            <h1 id="h1">Step 1: Stir it Up</h1>
            <p id="p1">In a large bowl, give the yeast, water and sugar a little stir. The water should be warm enough—ideally between 105º and 115º—to really get the yeast going.
            ...
            <img id="img2" src="../../assets/images/receta7.2.jpg">
        </div>
        </div>
    </div>
    <!------Footer------->
